...
type Server_KAFKA struct {
	...
	Consumer []*Server_KAFKA_Consumer `protobuf:"bytes,1,rep,name=consumer,proto3" json:"consumer,omitempty"`
}
...
func (x *Server_KAFKA) GetConsumer() []*Server_KAFKA_Consumer {
	if x != nil {
		return x.Consumer
	}
	return nil
...
type Server_KAFKA_Consumer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Server_KAFKA_Consumer) Reset() {
	*x = Server_KAFKA_Consumer{}
	if protoimpl.UnsafeEnabled {
...
func (x *Server_KAFKA_Consumer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_KAFKA_Consumer) ProtoMessage() {}

func (x *Server_KAFKA_Consumer) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_KAFKA_Consumer.ProtoReflect.Descriptor instead.
func (*Server_KAFKA_Consumer) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 0}
}

func (x *Server_KAFKA_Consumer) GetPartition() int32 {
	if x != nil {
		return x.Partition
	}
	return 0
...
func (x *Server_KAFKA_Consumer) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xf1, 0x03, 0x0a, 0x06, 0x53,
	...
	0x2e, 0x0a, 0x05, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
	0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x4b, 0x41, 0x46, 0x4b, 0x41, 0x52, 0x05, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x1a,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1d, 0x0a, 0x05, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x12,
	0x14, 0x0a, 0x05, 0x61, 0x64, 0x64, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05,
	0x61, 0x64, 0x64, 0x72, 0x73, 0x22, 0x7b, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	...
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x42, 0x23, 0x5a, 0x21,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x69,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_KAFKA_Consumer)(nil), // 9: kratos.api.Server.KAFKA.Consumer
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 13: kratos.api.Server.KAFKA.consumer:type_name -> kratos.api.Server.KAFKA.Consumer
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Server_KAFKA_Consumer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
